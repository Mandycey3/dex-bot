...
The bot administrator can also use Telegram directly:

```text
/admin
/ban <Telegram user ID> [optional reason]
/unban <Telegram user ID>
```

The administrator ID must be included in `BOT_ACTIVITY_OWNER_CHAT_ID` or
`BOT_ACTIVITY_ADMIN_CHAT_IDS`.
